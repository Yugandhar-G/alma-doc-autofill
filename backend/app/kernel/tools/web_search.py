...
Retrieved text is data, never instructions; agent prompts and distillation
steps both treat it as untrusted.
"""
import logging
...
logger = logging.getLogger("yunaki.kernel.web_search")
